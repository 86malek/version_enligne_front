...
$(document).ready(function() {
	...
	$(document).ready(function(){
		...
		$.ajax({
			...
			addProductNotice(''+product_name+'', '','<p>est ajouté au panier</p>', 'success');
		...
		{
			addProductNotice('Notification', '','<h3>Votre produit est ajouté au panier</h3>', 'danger');
		}
		});
		...
		$.ajax({
			...
			addProductNotice('Notification', '','<h3>Le produit est effacé de votre panier</h3>', 'danger');
			}
		})
		}
		else
		...
		success:function()
		{
			...
			/*$('#search_data').autocomplete({
				source: "https://expert-gaming.tn/include/fetch.php",
				minLength: 1,
